...
### Purposes
- Fetch US major indice futures (Nasdaq, S&P500 and Dow Jones) candlestick data and analysis their price actions
- Fetch US market top gainer stock candlestick data and analysis their price actions
...
1. Login IB Gateway
2. Run all scanners (`.bat`) files built from pyinstaller
